...
def iniciar_interfaz():
    ...
    titulo_label.place(relx=0.5, y=20, anchor='center') #.place(x=270, )
    ...
    origen_combo = ttk.Combobox(ventana, values=paraderos["Nombre"].tolist(), width=30)
    origen_combo.place(x=200, y=100)
    ...
    destino_combo = ttk.Combobox(ventana, values=paraderos["Nombre"].tolist(), width=30)
    destino_combo.place(x=200, y=140)
    ...
    find_route_button.place(x=150, y=200, width=200, height=45)

    # Sección para agregar un nuevo punto
    ttk.Label(ventana, text="Agregar Punto", font=("Helvetica", 14, "bold"), foreground='white', background='grey').place(x=580, y=80)

    # Campos para agregar un nuevo punto
    ttk.Label(ventana, text="Nombre:", foreground='white', background='grey').place(x=480, y=130)
    name_entry = tk.Entry(ventana, width=30)
    name_entry.place(x=580, y=130)
    ...
    x_entry = tk.Entry(ventana, width=10)
    x_entry.place(x=510, y=170)

    ttk.Label(ventana, text="Y:", foreground='white', background='grey').place(x=670, y=170)
    y_entry = tk.Entry(ventana, width=10)
    y_entry.place(x=700, y=170)
    ...
    add_button.place(x=580, y=220, width=200, height=45)
    ...
    tk.Button(button_frame, text="MOSTRAR MAPA", bg="#90e0ef", fg="white", width=button_width, height=button_height, command=mostrar_mapa).place(x=10, y=10)
    tk.Button(button_frame, text="MOSTRAR PUNTOS DE RECARGA", bg="#ffd60a", fg="white", width=button_width, height=button_height, command=mostrar_puntos_recarga).place(x=250, y=10)
    tk.Button(button_frame, text="MOSTRAR GRAFO", bg="#ff6b6b", fg="white", width=button_width, height=button_height, command=mostrar_ventana_seleccion_grafo).place(x=490, y=10)
    tk.Button(button_frame, text="PARADEROS MORADO", bg="#9c27b0", fg="white", width=button_width, height=button_height, command=lambda: mostrar_paraderos_por_color("Morado", "purple")).place(x=10, y=70)
    tk.Button(button_frame, text="PARADEROS ROJO", bg="#e63946", fg="white", width=button_width, height=button_height, command=lambda: mostrar_paraderos_por_color("Rojo", "red")).place(x=250, y=70)
    tk.Button(button_frame, text="PARADEROS AZUL", bg="#1e3a8a", fg="white", width=button_width, height=button_height, command=lambda: mostrar_paraderos_por_color("Azul", "blue")).place(x=490, y=70)
